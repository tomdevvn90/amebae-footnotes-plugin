...
/* WEBPACK VAR INJECTION */(function(jQuery) {jQuery(function ($) {
  ...
  $(document).on('mouseleave', '.af-footnote.af-footnote--hover-on-desktop,' + '.af-footnote.af-footnote--hover-on-desktop .af-footnote__connector,' + '.af-footnote__note--opened-by-hover', null, function (e) {
  ...
  $(document).on('click', '.af-footnote a', null, function (e) {
    ...
    if ($footnoteContent.is(":hidden")) {
      if ($(window).width() >= 768 && $(this).parent().is(":not(.af-footnote--expands-on-desktop)")) {
        ...
        //expandable style
        $(this).attr("aria-pressed", "true");
        $footnoteContent.removeClass('af-footnote__note--tooltip').addClass('af-footnote__note--expandable').css('display', 'block');
...
function af_hide_footnotes($footnoteAnchor) {
  ...
  if ($footnoteAnchor != null) {
    ...
    var _next = '.af-footnote__note[data-af="' + $footnoteAnchor.parent().attr("data-af") + '"]';
    var $note = $footnoteAnchor.parent().nextAll(_next).eq(0);
    $note.hide().css({
      'left': '',
      'top': ''
    });
    ...
    jQuery(".af-footnote__note").hide().css({
      'left': '',
      'top': ''
    });
...
function af_show_tooltip_footnote($footnoteElement, doNotTransferFocus, additionalClass) {
  ...
  var next = '.af-footnote__note[data-af="' + $footnoteElement.attr("data-af") + '"]';
  var $footnoteContent = $footnoteElement.nextAll(next).eq(0);
  $footnoteContent.show().addClass('af-footnote__note--tooltip').removeClass('af-footnote__note--expandable');
  if (additionalClass) {
  ...
  $footnoteContent.unbind('keydown').bind('keydown', function (event) {
    if (event.key == 'Escape') {
...
/***/ "./assets/scss/block-editor-button.scss":
/*!**********************************************!*\
  !*** ./assets/scss/block-editor-button.scss ***!
  \**********************************************/
/*! no static exports found */
...
/***/ 0:
/*!*************************************************************************************************!*\
  !*** multi ./assets/js/app.js ./assets/scss/styles.scss ./assets/scss/block-editor-button.scss ***!
  \*************************************************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
