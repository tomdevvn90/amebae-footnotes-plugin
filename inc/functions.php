...
function af_list_footnotes($show_only_when_printing = FALSE, $hide_when_printing = FALSE)
{
    ...
    $content .= '<div id="af-reference-ls"><h4>References:</h4><ul class="af-list ' . ($show_only_when_printing ? 'af-list--show-only-for-print' : '') . ($hide_when_printing ? 'af-list--hide-for-print' : '') . '">';
